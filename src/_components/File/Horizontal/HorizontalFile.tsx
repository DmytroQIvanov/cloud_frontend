...
import ImageNode from "@/_components/File/Horizontal/Image";
    ...
    if (file.mimetype?.includes("image")) {
      ...
      return (
        <video width="320" height="240" controls preload="none">
          <source src={file?.file_url} onLoadStart={() => setLoading(false)} />
        </video>
      );
    } else if (file.mimetype?.includes("audio")) {
      return <audio src={file?.file_url} controls></audio>;
    }
  };
